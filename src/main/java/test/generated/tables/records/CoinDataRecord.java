...
public class CoinDataRecord extends UpdatableRecordImpl<CoinDataRecord> implements Record5<Long, Long, String, Integer, Double> {
    ...
    @Override
    public Row5<Long, Long, String, Integer, Double> valuesRow() {
    ...
    @Override
    public CoinDataRecord value4(Integer value) {
    ...
    @Override
    public CoinDataRecord values(Long value1, Long value2, String value3, Integer value4, Double value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public CoinDataRecord(Long id, Long algoId, String coinName, Integer coinRevenue, Double exchangeRate) {
        super(CoinData.COIN_DATA);
